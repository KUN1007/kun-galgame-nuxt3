...
<template>
  <div class="relative w-full">
    ...
    <button
      :id="computedId"
      type="button"
      class="bg-background focus:border-primary-500 focus:ring-primary-500 flex w-full cursor-pointer items-center justify-between rounded-lg border px-3 py-2 text-left focus:ring-1 focus:outline-none sm:text-sm"
      :class="{
