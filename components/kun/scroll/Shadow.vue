...
const shadowStyles = computed(() => {
  ...
  return {
    start: { [sizeProperty]: props.shadowSize, backgroundImage: startGradient },
    end: { [sizeProperty]: props.shadowSize, backgroundImage: endGradient }
  }
})
</script>
...
<template>
  <div class="relative">
    ...
    <div
      ...
      "
    >
      <div ref="contentWrapper" :class="axis === 'horizontal' ? 'w-fit' : ''">
        <slot></slot>
      </div>
    </div>
