export const KUN_ACTIVITY_TYPE_TYPE: Record<string, string> = {
  ...
  TOPIC_CREATION: '帖子',
  MESSAGE_UPVOTE: '消息获赞',
  MESSAGE_SOLUTION: '采纳答案',
  TOPIC_REPLY_CREATION: '帖子回复',
  TOPIC_COMMENT_CREATION: '帖子评论',
  GALGAME_WEBSITE_CREATION: 'Galgame 站点',
  GALGAME_RESOURCE_CREATION: 'Galgame 资源',
  GALGAME_COMMENT_CREATION: 'Galgame 评论',
  GALGAME_PR_CREATION: 'Galgame PR',
  GALGAME_WEBSITE_COMMENT_CREATION: 'Galgame 站点评论',
  TODO_CREATION: '待办',
  UPDATE_LOG_CREATION: '更新日志',
  TOOLSET_CREATION: '工具集',
  TOOLSET_RESOURCE_CREATION: '工具集资源',
